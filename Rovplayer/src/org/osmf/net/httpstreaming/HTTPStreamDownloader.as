...
package org.osmf.net.httpstreaming
{
	...
	public class HTTPStreamDownloader
	{
		...
		private function onComplete(event:Event):void
		{
			...
			CONFIG::RENWEN{
				var time:int = (new Date().valueOf()  - _lastProgressTime.valueOf()) / 1000.0;
				var speed:Number = _downloadBytesCount / _downloadDuration;
				DownloadInfoUitls.instance.downloadSpeed = speed;
			}
		 ...
		 **/
		private var _lastProgressTime:Date;
		private function onProgress(event:ProgressEvent):void
		{
			...
			CONFIG::RENWEN{
				var time:int = (new Date().valueOf()  - _lastProgressTime.valueOf()) / 1000.0;
				var speed:Number = event.bytesLoaded / time;
				DownloadInfoUitls.instance.downloadSpeed = speed;
			}
